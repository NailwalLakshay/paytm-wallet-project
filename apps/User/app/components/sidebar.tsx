...
export const SidebarComp = ()=>{
    ...
    return (
        <div className={`sm:min-w-[250px] sm:border-r-2 border-b-2 p-2 sm:min-h-screen sm:static sm:z-0 ${active ? " absolute z-10 w-full bg-white" : " hidden"}`}>  
              <div className={`sm:block ${active ? "" : "hidden"}`}>
                {Links.map((item) : any=>{
